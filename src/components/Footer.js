...
const Footer = () => {
  ...
  const socialLinks = [
    { name: 'GitHub', url: 'http://github.com/ishordev1/' },
    { name: 'LinkedIn', url: 'https://www.linkedin.com/in/ishor1' },
    { name: 'Twitter', url: '#' },
    { name: 'Instagram', url: '#' }
  ];
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {currentYear} Ishor chaudhary. All rights reserved.
            </p>
